...
export const metadata = {
  title: "The Institute — The Verita Institute for AI Research",
  description: "Meet the team building The Verita — an independent institute for AI research and education across India and the United States.",
};
    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#fff" }}>
      ...
      <section className="two-col-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", borderBottom: `1px solid ${v.border}` }}>
        <div style={{ background: v.navy, padding: "64px 48px" }}>
          <div style={{ fontSize: 11, letterSpacing: 3, textTransform: "uppercase", color: v.blueLight, fontWeight: 600, marginBottom: 20 }}>The Institute</div>
        ...
        <div style={{ background: v.bgSoft, padding: "64px 48px" }}>
          <div style={{ fontSize: 11, letterSpacing: 3, textTransform: "uppercase", color: v.blueLight, fontWeight: 600, marginBottom: 20 }}>Who We Are Building</div>
          ...
          <div style={{ marginTop: 24 }}>
            <a href="mailto:hello@theveritaai.com" style={{ background: v.navy, color: "#fff", padding: "12px 24px", fontSize: 13, textDecoration: "none", fontWeight: 600, display: "inline-block" }}>Get in touch — hello@theveritaai.com</a>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "72px 48px", borderBottom: `1px solid ${v.border}` }}>
        <div style={{ fontSize: 11, letterSpacing: 3, textTransform: "uppercase", color: v.blueLight, fontWeight: 600, marginBottom: 16 }}>Founding Team</div>
        <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 32, fontWeight: 600, color: v.navy, marginBottom: 40, lineHeight: 1.2, maxWidth: 560 }}>The people building The Verita.</div>
        <div className="three-col-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 2, background: v.bgRule }}>
          {TEAM.map((t) => (
            <div key={t.name} style={{ background: "#fff", padding: "32px 28px" }}>
              ...
              <div style={{ fontSize: 12, color: v.blue, fontWeight: 600, letterSpacing: 0.5, marginBottom: 12 }}>{t.role}</div>
      ...
      <section style={{ padding: "72px 48px", borderBottom: `1px solid ${v.border}`, background: v.bgSoft }}>
        <div style={{ fontSize: 11, letterSpacing: 3, textTransform: "uppercase", color: v.blueLight, fontWeight: 600, marginBottom: 16 }}>Advisory Board</div>
          ...
          {ADVISORY.map((b) => (
            <div key={b.name} style={{ background: "#fff", padding: "28px 28px", display: "flex", gap: 16, alignItems: "flex-start" }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 11, color: v.blue, fontWeight: 600, letterSpacing: 0.3, marginBottom: 8 }}>{b.role}</div>
        ...
        <div style={{ marginTop: 16, padding: "20px 28px", background: "#fff", borderLeft: `3px solid ${v.blue}` }}>
          <p style={{ fontSize: 13, color: v.textBody, lineHeight: 1.7 }}>Interested in joining the advisory board? Contact us at <a href="mailto:hello@theveritaai.com" style={{ color: v.blue, textDecoration: "none", fontWeight: 600 }}>hello@theveritaai.com</a></p>
        </div>
      </section>
