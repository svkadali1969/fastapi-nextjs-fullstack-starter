...
const RESPONSES: Record<string, string> = {
  ...
  partner: "There are several ways to partner with The Verita — commission a sector research study, enrol your team in the AI Leadership Cohort or The Intelligent Enterprise Intensive, or become a Founding Research Partner. Contact hello@theveritaai.com to start the conversation.",
};
...
function getResponse(input: string): string {
  ...
  return "Thank you for your question. The Verita focuses on three areas: The Future Workforce, Responsible AI in Practice, and Applied Sector Research. For a detailed conversation, please contact hello@theveritaai.com.";
}
